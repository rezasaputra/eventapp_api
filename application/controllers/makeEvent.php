...
class makeEvent extends CI_Controller {
    function __construct()
    {
        parent::__construct();
        // $this->load->model('MyModel', '', TRUE);
        $this->load->model('Model_event', '', TRUE);
        $this->load->model('Model_makeEvent','',TRUE);
    ...
    function all_event($id='')
    {
    	...
    	} else 
    	{
            ...
            {
        		$data = $this->Model_event->tampil_event($id);
